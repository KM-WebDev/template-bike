...
function Background() {
    return (
        <div
            className={cn(
                "absolute top-0 right-0 bottom-0 left-0 z-0 mx-auto bg-black/20",
                "bg-[linear-gradient(90deg,rgba(0,0,0,0.9)_10%,rgba(0,0,0,0.8)_50%,rgba(0,0,0,0.2))]"
            )}
        />
    );
}
...
function HeroContent() {
    return (
        <div className="z-100 w-full max-w-[1200px]">
            <div className="z-100 flex w-full max-w-[700px] flex-col gap-8">
                <motion.div
                    initial={textInitial}
                    animate={textAnimate}
                    transition={textTransition}
                >
                    <Heading semantic="h1" className="text-nowrap text-white">
                ...
                <motion.div
                    ...
                    className="z-100 flex flex-wrap gap-6"
                >
                    <HeroButtons />
                </motion.div>
            </div>
